 ...
 */
public class TelaVisualizacao extends javax.swing.JDialog {

    public TelaVisualizacao(java.awt.Frame parent, Contato contato) {
        super(parent, true);
        initComponents();
        preencherDados(contato);
    }
    
    public TelaVisualizacao(Contato contato) {
        super((Frame) null, true);
        initComponents();
        preencherDados(contato);
    }

    private void preencherDados(Contato contato) {
        ...
        gbc.gridx = 1;
        JLabel lblId = new JLabel(String.valueOf(contato.getId()));
        ...
        gbc.gridx = 1;
        JLabel lblNome = new JLabel(contato.getNome());
        ...
        gbc.gridx = 0;
        gbc.gridy = linha;
        JLabel lblTelefoneLabel = new JLabel("Telefone:");
        lblTelefoneLabel.setFont(new Font("Segoe UI", Font.BOLD, 14));
        painelInfo.add(lblTelefoneLabel, gbc);
        
        gbc.gridx = 1;
        JLabel lblTelefone = new JLabel(contato.getTelefone());
        lblTelefone.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        painelInfo.add(lblTelefone, gbc);
        ...
        painelInfo.add(lblEmailLabel, gbc);
        
        gbc.gridx = 1;
        JLabel lblEmail = new JLabel(contato.getEmail());
        lblEmail.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        painelInfo.add(lblEmail, gbc);
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Detalhes do Contato");

        painelInfo.setLayout(new java.awt.GridBagLayout());

        painelBotao.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER));
